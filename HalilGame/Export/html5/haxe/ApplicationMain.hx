...
@:dox(hide) class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("HalilGame", create);
	...
	public static function create(config:Dynamic):Void
	{
		...
		app.meta.set("file", "HalilGame");
		app.meta.set("name", "Halil Penny Game");
		app.meta.set("packageName", "com.halil.game");
		...
		#elseif air
		app.window.title = "Halil Penny Game";
		#else
		app.window.context.attributes.background = 16753920;
