...
class ApplicationMain
{
	...
	public static function main()
	{
		...
		lime.system.System.embed("HalilGame", null, 800, 600);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "HalilGame";
		app.meta["name"] = "HalilGame";
		app.meta["packageName"] = "com.sample.halilgame";
